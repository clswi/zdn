...
//  ZendeBebin
//
//  Created by Ahmadreza Rahimi on 12/1/19.
...
class RadioVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
...
func fetchDatax() {
    ...
    Alamofire.request("https://zendebebin.ir/api/main/radio.php").responseJSON { response in
        ...
        func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath){
            ...
            let modal = storyBoard.instantiateViewController(withIdentifier: "dradiox") as! dradioVC
            modal.getimg = self.img[indexPath.row]
